...
########################################################################
# IMPORT GUI FILE
from designer_pyside.src.ui_QCustomQMainWindow import *
########################################################################
# IMPORT FUNCTION
from designer_pyside.src.MJ_application.gui_fonctions import GuiFunctions
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        loadJsonStyle(self, self.ui, jsonFiles = {
            "designer_pyside/json-styles/style.json"
            }) 
