...
**TODO**
- Régler les thèmes en utilisant widget custom (https://www.youtube.com/watch?v=JK-B-CT34EU&t=2338s) (regarde la description aussi)
- Régler l'erreur lié avec l'ouverture du serveur (regarde le log dans l'application)
- Coder le site web
